        ...
        <SettingsTab>
            {(isEquicordDonor(user?.id) || isVencordDonor(user?.id)) ? (
                ...
                <SpecialCard
                    ...
                    description="Please consider supporting the development of Bhopcord by donating!"
            ...
            {isAnyPluginDev(user?.id) && (
                <SpecialCard
                    ...
                    description="Since you've contributed to Bhopcord you now have a cool new badge!"
            ...
            <Paragraph className={Margins.bottom16}>
                Configure how Bhopcord behaves and integrates with Discord. These settings affect the Discord client's appearance and behavior.
            </Paragraph>
            ...
            <Paragraph className={Margins.bottom16}>
                Configure how Bhopcord handles notifications. You can customize when and how you receive alerts, or view a history of past notifications.
            </Paragraph>
...
export default wrapTab(EquicordSettings, "Bhopcord Settings");
